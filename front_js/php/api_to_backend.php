...
if ( @$_GET['command'] == 'rates' ) {
	//echo '{"crypto":[{"code":"BTC","id":"bitcoin","name":"Bitcoin","type":"crypto","icon":"₿","priceUsd":63376},{"code":"ETH","id":"ethereum","name":"Ethereum","type":"crypto","icon":"Ξ","priceUsd":1878.24},{"code":"USDT","id":"tether","name":"Tether","type":"crypto","icon":"₮","priceUsd":0.999129},{"code":"BNB","id":"binancecoin","name":"BNB","type":"crypto","icon":"BNB","priceUsd":564.26}],"fiat":[{"code":"USD","type":"fiat","name":"Dólar estadounidense","symbol":"$","flag":"🇺🇸","priceUsd":1},{"code":"EUR","type":"fiat","name":"Euro","symbol":"€","flag":"🇪🇺","priceUsd":1.137912749402027},{"code":"MXN","type":"fiat","name":"Peso mexicano","symbol":"$","flag":"🇲🇽","priceUsd":0.0572872471942425},{"code":"CLP","type":"fiat","name":"Peso chileno","symbol":"$","flag":"🇨🇱","priceUsd":0.001053628646590044},{"code":"ARS","type":"fiat","name":"Peso argentino","symbol":"$","flag":"🇦🇷","priceUsd":0.0006673287902923948},{"code":"COP","type":"fiat","name":"Peso colombiano","symbol":"$","flag":"🇨🇴","priceUsd":0.0003109825348706753},{"code":"PEN","type":"fiat","name":"Sol peruano","symbol":"S/","flag":"🇵🇪","priceUsd":0.2940866814611873},{"code":"BRL","type":"fiat","name":"Real brasileño","symbol":"R$","flag":"🇧🇷","priceUsd":0.196392235358026},{"code":"UYU","type":"fiat","name":"Peso uruguayo","symbol":"$","flag":"🇺🇾","priceUsd":0.02491909641562222},{"code":"PYG","type":"fiat","name":"Guaraní paraguayo","symbol":"₲","flag":"🇵🇾","priceUsd":0.0001656205686483018},{"code":"BOB","type":"fiat","name":"Boliviano","symbol":"Bs","flag":"🇧🇴","priceUsd":0.0904435450939306},{"code":"VES","type":"fiat","name":"Bolívar venezolano","symbol":"Bs","flag":"🇻🇪","priceUsd":0.001346238374390238},{"code":"GTQ","type":"fiat","name":"Quetzal guatemalteco","symbol":"Q","flag":"🇬🇹","priceUsd":0.1310861840536541},{"code":"HNL","type":"fiat","name":"Lempira hondureño","symbol":"L","flag":"🇭🇳","priceUsd":0.03734359057204294},{"code":"NIO","type":"fiat","name":"Córdoba nicaragüense","symbol":"C$","flag":"🇳🇮","priceUsd":0.027177394408620714},{"code":"CRC","type":"fiat","name":"Colón costarricense","symbol":"₡","flag":"🇨🇷","priceUsd":0.0021968385823203087},{"code":"PAB","type":"fiat","name":"Balboa panameño","symbol":"B/","flag":"🇵🇦","priceUsd":1},{"code":"DOP","type":"fiat","name":"Peso dominicano","symbol":"RD$","flag":"🇩🇴","priceUsd":0.017190812239748294},{"code":"CUP","type":"fiat","name":"Peso cubano","symbol":"$","flag":"🇨🇺","priceUsd":0.041666666666666664},{"code":"CAD","type":"fiat","name":"Dólar canadiense","symbol":"$","flag":"🇨🇦","priceUsd":0.7084802248999625}],"updatedAt":1785219565384,"live":true}';
	echo file_get_contents('https://banco-latinoamericano.onrender.com/api/rates');
	exit;
}
else
if ( @$_GET['command'] == 'history' ) {
	...
	echo file_get_contents('https://banco-latinoamericano.onrender.com/api/history?asset='.$_GET['param1'].'&days='.$_GET['param2']);
	exit;
}
else {
    $data = make_appserver_request($_GET['command'], [], $_POST);
