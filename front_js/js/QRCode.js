...
(function (ninja) {
	var qrC = ninja.qrCode = {
		...
		createCanvas: function (text, sizeMultiplier, canvas_id) {
		...
		showQrCode: function (keyValuePair, sizeMultiplier, canvas_id) {
			for (var key in keyValuePair) {
				var value = keyValuePair[key];
				try {
					if (document.getElementById(key)) {
						document.getElementById(key).innerHTML = "";
						document.getElementById(key).appendChild(qrC.createCanvas(value, sizeMultiplier, canvas_id));
					}
				}
				catch (e) {	}
			}
